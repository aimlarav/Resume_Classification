...
Original file is located at
    https://colab.research.google.com/drive/1oGflAldEDa8Dt5Jjan7r-eihPquAhaj6
...
uploaded = files.upload() # Upload files to the current directory
try:
    model = pk.load(open(r'modelDT.pkl', 'rb'))
    Vectorizer = pk.load(open(r'vector.pkl', 'rb'))
except FileNotFoundError as e:
    st.error(f"Error loading model or vector files. Please make sure 'modelDT.pkl' and 'vector.pkl' are uploaded. The error is: {e}")
    st.stop()
